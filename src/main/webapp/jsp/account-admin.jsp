                        ...
                        <div class="col-sm-12 col-md-3 col-lg-3">
                            ...
                            <div class="dashboard_tab_button">
                                <ul role="tablist" class="nav flex-column dashboard-list">
                                    ...
                                    <li><a href="/managerregister" >添加管理员</a>
                                    </li>
                                ...
                                <div class="tab-pane fade" id="users">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table" id="users-table">
                                            ...
                                            <tbody>
                                            <!--AccountController里81、82行-->
                                            <c:forEach items="${userList}" var="c" varStatus="status">
                                                <tr>
                                                    <td>${status.index+1}</td>
                                                    <td><a href="/account/user/edit/${c.id}">${c.username}</a></td>
                                                    <td>${c.displayName}</td>
                                                    <td>${c.phone}</td>
...
<%--                                            <c:forEach items="${managerList}" var="c" varStatus="status">--%>
<%--                                                <tr>--%>
<%--                                                    <td>${status.index+1}</td>--%>
<%--                                                    <td>${c.username}</td>--%>
<%--                                                    <td>${c.displayName}</td>--%>
...
<%--                                                        <c:choose>--%>
<%--                                                            <c:when test="${c.status == 1}">--%>
<%--                                                                <a href="javascript:void(0)" title="禁止该管理员登录"--%>
<%--                                                                   class="update_user_status text-danger"--%>
<%--                                                                   data-id="${c.id}" class="view">禁用</a>--%>
<%--                                                            </c:when>--%>
<%--                                                            <c:otherwise>--%>
                                                    ...
                                                    <td>
                                                        <c:choose>
                                                            ...
                                                            <c:when test="${c.status == 3}">
                                                                <span class="text-primary">已下架</span>
                                                            </c:when>
                                                            <c:otherwise>
                                        ...
                                        <table class="table" id="biddings-table">
                                            ...
                                            <c:forEach items="${biddingList}" var="c" varStatus="status">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/product/${c.product.id}" class="view" >查看</a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                            </tbody>
                                        ...
                                        <table class="table" id="orders-table">
                                            ...
                                            <c:forEach items="${orderList}" var="c" varStatus="status">
                                                <tr>
                                                    ...
                                                    <td>${c.address}</td>
                                                    <td>
                                                        <a href="/account/order/edit/${c.id}" class="view"  target="_blank" >修改收货地址</a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                            </tbody>
